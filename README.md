## Advance Burger Builder using React Js
This project was bootstrapped with Create React App and following technology stack has been used:

- User Interface - React Js > 16.6
- React State Management - Redux Store
- Navigation - React Routers
- Api Calls- Axios Modules
- Styling - Css Module , Css 3
- Database- Real time Database Firebase
- Authentication - FireBase Authentication

## Live Demo ?
https://burgerbuilder-265a5.firebaseapp.com/

## Prerequisites
Get a Firebase Realtime Database and replace your endpoint URL with all the API calls. Search for axios.get and axios.post in the project for API calls

Your database should have an aleast ingredients key with data for best Experience:

{ meat: 0, bacon: 0, salad: 0, cheese: 0 }
...
## For More Information , Refer Below the Table of Contents
